    ...
    <div className="flex flex-col">
      ...
      <section className="relative h-screen min-h-[700px] flex items-center overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-20">
          ...
          >
            <div className="w-[500px] h-[500px] rounded-full border border-white/10 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" />
            <div className="w-[400px] h-[400px] rounded-full border border-gold/20 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" />
            <img 
              src="https://images.unsplash.com/photo-1594631252845-29fc4586c562?q=80&w=800" 
              alt="Kulhad Chai"
              className="w-full h-auto relative z-10 drop-shadow-[0_20px_50px_rgba(201,168,76,0.3)] rounded-2xl"
              referrerPolicy="no-referrer"
            />
          </motion.div>
        </div>
